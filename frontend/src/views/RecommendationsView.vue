...
<template>
  <div class="page fade-in">
    <div class="container">
      ...
      <!-- Специальный заголовок для рекомендаций -->
      <div class="recommendations-header card">
        <h1 class="title">Рекомендовано для вас</h1>
        <p class="subtitle">
          Пока система машинного обучения обучается на ваших кликах, мы показываем вам последние вакансии. 
          Ставьте лайки и откликайтесь, чтобы улучшить рекомендации!
        </p>
      </div>
...
<style scoped>
.recommendations-header { padding: 30px; margin-bottom: 30px; text-align: center; } .title { font-size: 2rem; font-weight: 800; color: var(--primary); }
